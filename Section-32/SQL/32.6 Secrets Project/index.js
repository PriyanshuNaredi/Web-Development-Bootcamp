...
// Creating Local Session, keep the USER LoggedIn Until session ends
app.use(
  session({
...
// Passports Google-OAuth, called from login.ejs submit form
app.get(
  "/auth/google",
...
// called after Google-OAuth Auth is done
app.get(
  "/auth/google/secrets",
  passport.authenticate("google", {
...
// after local(cookie) auth is done
app.post(
  "/login",
...
// user already exists, no password check req(Google-OAuth)
